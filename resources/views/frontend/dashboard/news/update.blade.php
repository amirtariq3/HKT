...
<div class="container-fluid">
	...
	<div class="row">
		...
		<div class="col-sm-12">
			<h5 class="page-title">Update News</h5>
				...
				<form method="post" enctype="multipart/form-data">	
					...
					<div class="card-body">
						...
						<div class="form-group row">
							...
							<div class="col-sm-10">
								<input class="form-control" id="#name" type="text" name="title" value="{{$news->title}}" >
						...
						<div class="form-group row">
							...
							<div class="col-sm-10">
								<textarea class="form-control" name="short_detail">{{$news->short_detail}}</textarea>
							</div>
						</div>
						<div class="form-group row">
							...
							<div class="col-sm-10">
								<select class="form-control" name="category_id">
									@foreach ($data as $i)
									<option {{($news->news_category_id == $i->id)? 'selected': ''}} value="{{$i->id}}">{{$i->name}}</option>
						...
						<div class="form-group row">
							...
							<div class="col-sm-10">
								<textarea name="description" class="form-control summernote">{{$news->detail}}</textarea>
							</div>
						</div>
						...
						<div class="form-group row">
							...
							<div class="col-sm-10">
                                ...
                                <img src="{{asset('public/images/'.$news->image)}}" width="100">
							</div>
						</div>
						<div class="form-group row">
