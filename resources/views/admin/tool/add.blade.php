    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h3 class='card-heading p-1 pl-3'>Add Widgets & Resources</h3>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="card-body">
                        <div class="row">
                        <form method="post" action="{{route('admin.tool.store')}}">
                            @csrf
                            <div class="col-md-10">
                                ...
                                <div class="form-group">
                                    <label>Link</label>
                                    <input type="text" class="form-control" id="basicInput" placeholder="Enter name" name="link" >
                                </div>
