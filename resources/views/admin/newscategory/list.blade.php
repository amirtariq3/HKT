                ...
                <div class="row">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="btn">
                                <a class="btn btn-primary pull-right" href="{{route('admin.news-category.create')}}" style="margin-left: 780px; margin-bottom:18px;">Add New</a>
                                </div>
                        ...
                        <script type="text/javascript">
                          $(function () {
                            ...
                            var table = $('.data-table').DataTable({
                                processing: true,
                                serverSide: true,
                                ajax: "{{route('admin.news-category.list')}}",
                                columns: [
                                    {data: 'id', name: 'id'},
                                    {data: 'name', name: 'name'},
