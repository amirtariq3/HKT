                ...
                <div class="row">
                    <div class="card-body">
                        <div class="row">
                            <h3>City List</h3>
                            <div class="btn">
                                <a class="btn btn-primary pull-right" href="{{route('admin.city.create')}}" style="margin-left: 780px; margin-bottom:18px;">Add New</a>
                                </div>
                          ...
                          $(function () {
                            ...
                            var table = $('.data-table').DataTable({
                                ...
                                columns: [
                                    ...
                                    {
                        data: function(row){
                            return '<small>'+row.country.name+"</small>";
                        }
                    },
