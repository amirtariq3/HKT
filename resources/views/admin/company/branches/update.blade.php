    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-header">
                <h3 class='card-heading p-1 pl-3'>Update Branche</h3>
            </div>
            <div class="card-body">
                        ...
                        <form method="POST"  enctype="multipart/form-data">
                            ...
                            <div class="col-md-10">
                                ...
                                <div class="form-group">
                                    <label>Company</label>
                                    <select class="form-select" id="basicSelect" name="company_id" disabled="true">
                            ...
                            <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="{{$row->branch}}" id="basicInput" placeholder="Enter Branch" name="name" required>
                            </div>
                            ...
                            <div class="form-group">
                                <label>Phone</label>
                                <input type="text" class="form-control" id="basicInput" value="{{$row->phone}}" placeholder="Enter Phone" name="phone" required>
                            </div>

                            <div class="form-group">
                                <label>Email</label>
                                <input type="email" class="form-control" id="basicInput" value="{{$row->email}}" placeholder="Enter Email" name="email" required>
                            </div>
