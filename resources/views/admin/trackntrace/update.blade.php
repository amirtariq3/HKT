    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h3 class='card-heading p-1 pl-3'>Update Airport</h3>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="card-body">
                        <div class="row">
                        <form method="POST" action="{{route('admin.trackntrace.update', [$data->id])}}" enctype="multipart/form-data">
                            @method('PUT')
                            @csrf
                            <div class="col-md-10">
                        ...
                        <div class="form-group">
                            <label>URL</label>
                            <input type="text" class="form-control" id="basicInput" placeholder="Enter URL" value="{{$data->url}}" name="url" >
                        </div>
